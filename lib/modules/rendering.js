                    ...
                    const liquidOpts = merge(
                        {
                            ...
                            customFilters: {
                                ...
                                stylesheet_tag: (href, nonce, defer) =>
                                    `<link href="${href}" rel="stylesheet" type="text/css" media="all" ${defer ? 'defer' : ''} nonce="${nonce}"/>`,
                                javascript_tag: (src, nonce, defer) =>
                                    `<script src="${src}" rel="stylesheet" type="text/javascript" ${defer ? 'defer' : ''} nonce="${nonce}"></script>`,
                                img_tag: (src, alt) =>
