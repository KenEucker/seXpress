...
module.exports = function (renderer) {
	const self = this
	let rendererToUse = typeof renderer === 'string' ? renderer : typeof renderer === 'function' ? 'custom' : this.config.renderer
	...
	switch(rendererToUse) {
		...
		case 'liquid': 
			...
			const liquid = new Liquid({ dynamicPartials: true, strict_filters: true, root: ["_includes", this.config.viewsFolder] })
