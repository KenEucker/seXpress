                    ...
                    const liquidOpts = merge(
                        {
                            ...
                            customFilters: {
                                console_log: (data, nonce) => `<script nonce="${nonce}">console.log(${data})</script>`,
                                stylesheet_tag: (href) =>
								...
								ie_script: (src) => `<!-- [if lte IE 9]><script src="${src}"></script><![endif] -->`,
								ie_style: (src) => `<noscript><!--[if lte IE 9]><link rel="stylesheet" href="${src}" /><![endif]--></noscript>`,
								safe_script: (inner, nonce) => `<script nonce="${nonce}" type="text/javascript">${inner}</script>`,
								safe_style: (inner, nonce) => `<style nonce="${nonce}" type="text/css">${inner}</style>`,
