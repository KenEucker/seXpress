...
function InitNotifications(initial, notificationsOpts = {}) {
    ...
    if (this.config.notifications.enabled) {
        ...
        if (
            ...
            this.log.info(`${moduleEmoji} VAPID Keys generated (SAVE THESE): ${JSON.stringify(vapidKeys)}`)
        } else {
            this.log.debug(`${moduleEmoji} VAPID Keys loaded from configuration`, { publicKey: this.config.notifications.vapidPublicKey, privateKey: this.config.notifications.vapidPrivateKey })
		}
        ...
        const subscribeToNotifications = (req, res) => {
            ...
            this.log.info(`${moduleEmoji} browser user subscribed to notifications`, { subscription })
        ...
        this.log.info(`${moduleEmoji} Browser notifications have been enabled`, this.config.notifications)
    }
}
