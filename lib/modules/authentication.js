...
function InitAuthentication(initial, authenticationOps = {}) {
	...
	*/
            ...
            typeof this.config.authentication.imgur.imgurUserValidator === 'function'
                ...
                : (profile, subdomain, authTokens) => {
                      if (authTokens.opts.imgurEmailAddress)
                          return (
                              profile !== null && profile.username === authTokens.opts.imgurEmailAddress
                          )
                      if (authTokens.opts.username)
                          return profile !== null && profile.username === authTokens.opts.username
        ...
        const redditUserValidator =
            typeof this.config.authentication.reddit.redditUserValidator === 'function'
                ...
                : (profile, subdomain, authTokens) => {
                      ...
                      if (authTokens.opts.username)
                          return profile !== null && profile.name === authTokens.opts.username
            ...
            typeof this.config.authentication.google.googleUserValidator === 'function'
                ...
                : (profile, subdomain, authTokens) => {
                      ...
                      if (authTokens.opts.googleEmailAddress)
                          return (
                              profile !== null && profile.username === authTokens.opts.googleEmailAddress
                          )
                      if (authTokens.opts.username)
                          return profile !== null && profile.username === authTokens.opts.username
            ...
            typeof this.config.authentication.github.githubUserValidator === 'function'
                ...
                : (profile, subdomain, authTokens) => {
                      ...
                      if (authTokens.opts.githubEmailAddress)
                          return (
                              profile !== null && profile.username === authTokens.opts.githubEmailAddress
                          )
                      if (authTokens.opts.username)
                          return profile !== null && profile.username === authTokens.opts.username
    ...
    if (this.config.authentication.instagram && this.config.authentication.instagram.instagramClientID) {
            ...
            typeof this.config.authentication.instagram.instagramUserValidator === 'function'
                ...
                : (profile, subdomain, authTokens) => {
                      ...
                      if (authTokens.opts.instagramEmailAddress)
                          return (
                              profile !== null && profile.username === authTokens.opts.instagramEmailAddress
                          )
                      if (authTokens.opts.username)
                          return profile !== null && profile.username === authTokens.opts.username
