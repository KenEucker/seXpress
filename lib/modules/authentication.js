...
module.exports = function (authenticationOps = {}) {
	...
	*/
    ...
    if (this.config.security.imgur && this.config.security.imgur.imgurClientID) {
        const imgurOpts = {
            clientID: this.config.security.imgur.imgurClientID,
            clientSecret: this.config.security.imgur.imgurClientSecret,
            callbackURL: this.config.security.imgur.imgurCallbackURL || '/auth/imgur/callback',
            passReqToCallback: true,
        }
    ...
    if (this.config.security.reddit && this.config.security.reddit.redditClientID) {
        const redditOpts = {
            clientID: this.config.security.reddit.redditClientID,
            clientSecret: this.config.security.reddit.redditClientSecret,
            callbackURL: this.config.security.reddit.redditCallbackURL || '/auth/reddit/callback',
            passReqToCallback: true,
        }
    ...
    if (this.config.security.google && this.config.security.google.googleClientID) {
        const googleOpts = {
            clientID: this.config.security.google.googleClientID,
            clientSecret: this.config.security.google.googleClientSecret,
            callbackURL: this.config.security.google.googleCallbackURL || '/auth/google/callback',
            passReqToCallback: true,
        }
        this.log.info(
            'configuring google API authentication for appID:',
            this.config.security.googleClientID,
        )
