    ...
    const configurePassportMiddleware = (
        ...
        for (const subdomain of Object.keys(this.config.subdomains)) {
            ...
            const subdomainStrategyOpts = util.merge(defaultStrategyOpts, {
                scope: subdomainMiddlewareOpts.scope || defaultStrategyOpts.scope,
                clientID: subdomainMiddlewareOpts[keys.clientID] || defaultStrategyOpts.clientID,
                clientSecret:
                    subdomainMiddlewareOpts[keys.clientSecret] || defaultStrategyOpts.clientSecret,
                callbackURL:
                    subdomainMiddlewareOpts[keys.clientCallbackURL] ||
                    defaultStrategyOpts.callbackURL,
                clientAccessToken:
                    subdomainMiddlewareOpts[keys.clientAccessToken] ||
                    defaultStrategyOpts.clientAccessToken,
                clientRefreshToken:
                    subdomainMiddlewareOpts[keys.clientRefreshToken] ||
                    defaultStrategyOpts.clientRefreshToken,
            })
