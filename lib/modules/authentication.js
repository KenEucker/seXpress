...
module.exports = function InitAuthentication(initial, authenticationOps = {}) {
    /*
	...
	*/
	...
	if (authsInitialized.length) {
		this.log.info(
			`🗝  authorization providers have been initialized ${util.consoleLogEmojiNumber(authsInitialized.length)}`,
