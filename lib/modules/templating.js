...
function InitTemplating(initial, templatingOpts = {}) {
            ...
            if (!!this.config.subdomains[subdomain]) {
                ...
                if (!!subdomainTemplate) {
                    ...
                    if (existsSync(subdomainTemplatePath)) {
                        this.log.debug(moduleName, `🚠 configuring static path for subdomain: ${subdomain}`, {
                            subdomainTemplate,
    ...
    this.log.debug(moduleName, `🚠 configuring static path for the base override files`, baseOverride)
