...
module.exports = function () {
    const staticOpts = this.config.static || {
        index: false,
    }
    ...
    if (!!this.config.subdomains) {
        ...
        if (this.config.headless) {
            ...
            this.log.info('routing all basepath requests to configured templates')
            indexHandler = (subdomain, req, res, host, next) => {
    ...
    this.app.use(express.static(baseOverride, staticOpts))
