...
function InitImport(initial, importOpts = {}) {
    this.config.export = this.getCoreOpts(moduleName, importOpts, initial)
...
module.exports = InitImport
module.exports.module = moduleName
module.exports.description = 'builds new services from a single json object'
