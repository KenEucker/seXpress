    ...
    registerController(controller, root = '') {
        ...
        if (typeof controller.routes === 'function') {
            ...
            if (this._customRoutesAdded.length) {
                logControllerAction(
                    `custom routes: ${this.util.consoleLogEmojiNumber(this._customRoutesAdded.length)}`,
                )
        ...
        if (!getSwaggerSpecResponse || uncached) {
            const defaultOpenApiDefinition = {
                ...
                externalDocs: {
                    ...
                    url: this.util.getHostUri(opts, opts.host, undefined, opts.api.docsEndpoint, true),
                },
