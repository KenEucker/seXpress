...
class Sexpress {
	...
	crypto(secret = null) {
		...
		return {
			...
			decrypt: this.middlewares.encrypt.decrypt.bind(this.middlewares.encrypt, secret || this.config.secret),
			encrypt: this.middlewares.encrypt.encrypt.bind(this.middlewares.encrypt, secret || this.config.secret),
		}
	}
