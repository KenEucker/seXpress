...
class Sexpress {
    ...
    initMiddlewares(middlewares = {}) {
        ...
        middlewaresNames.forEach(async (middleware) => {
			...
			await middlewareInstance.init ? middlewareInstance.init(this.middlewares) : Promise.resolve()
    ...
    async stop() {
        ...
        Object.keys(this.middlewares).forEach(async (middleware) => {
            await this.middlewares[middleware].close ?  this.middlewares[middleware].close() : Promise.resolve()
		})
