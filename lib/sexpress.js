    ...
    setConfiguration(config) {
        ...
        const authorName = 
			!!this.config.author && typeof this.config.author === 'object'
				...
				: (typeof this.config.author === 'string' && this.config.author.lenght ? this.config.author : defaultAuthorName)
        const authorEmail =
			!!this.config.author && typeof this.config.author === 'object'
                ? this.config.author.email 
				: (typeof this.config.author === 'string' ? this.util.extractEmails(this.config.author)[0] : defaultAuthorEmail)
