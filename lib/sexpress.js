...
const {
	version
} = require(getRootPath("package.json"))

const debugFilename = getRootPath("config.debug")
...
class Sexpress {
	...
	run(
		...
		// console.trace('running Sexpress')
